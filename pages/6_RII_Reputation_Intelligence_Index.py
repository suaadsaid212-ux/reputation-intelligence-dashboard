...
k1.metric("Exposure", round(exposure_score, 2))
k2.metric("Vulnerability", round(vulnerability_score, 2))
k3.metric("Resilience", round(resilience_score, 2))
k4.metric("RII", round(rii, 2))
